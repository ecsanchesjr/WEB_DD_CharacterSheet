...
-- Table `web`.`Player`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Player` ;
...
-- Table `web`.`Character`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Character` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Attributes` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`SavingThrows` ;
...
-- Table `web`.`Skills`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Skills` ;
...
-- Table `web`.`Attacks`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Attacks` ;
...
-- Table `web`.`Features`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Features` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`ProfAndLang` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`InventAndEquip` ;
...
-- Table `web`.`Status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `web`.`Status` ;
